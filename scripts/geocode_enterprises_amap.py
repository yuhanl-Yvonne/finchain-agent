...
INPUT_FILE = ROOT / "outputs" / "low_altitude_pipeline" / "企业主表.csv"
OUTPUT_DIR = ROOT / "outputs" / "geocode_results"
OUTPUT_CSV = OUTPUT_DIR / "企业坐标表.csv"
OUTPUT_XLSX = OUTPUT_DIR / "企业坐标表.xlsx"
...
def main() -> None:
    ...
    for _, row in df.iterrows():
        ...
        company_name = clean_value(row["公司名称"])
